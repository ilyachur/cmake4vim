...
command!       -nargs=1 -complete=custom,cmake4vim#CompleteConfigurePreset CMakeSelectConfigurePreset call cmake4vim#SelectConfigurePreset(<f-args>)
command!       -nargs=1 -complete=custom,cmake4vim#CompleteBuildPreset     CMakeSelectBuildPreset     call cmake4vim#SelectBuildPreset(<f-args>)
command!       -nargs=1 -complete=custom,cmake4vim#CompleteTestPreset      CMakeSelectTestPreset      call cmake4vim#SelectTestPreset(<f-args>)
command!       -nargs=1 -complete=custom,cmake4vim#CompleteWorkflowPreset  CMakeWorkflow              call cmake4vim#CMakeWorkflow(<f-args>)

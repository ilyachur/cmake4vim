...
This plugin allow to specify cmake targets in order to avoid building of all project. If you use [CtrlP](https://github.co m /ctrlpvim/ctrlp.vim) you can use it to select cmake target.
